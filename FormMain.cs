...
namespace TOFSensorSampleGetResult
{
    ...
    public partial class FormMain : Form
    {
        ...
        private void SetCommand()
        {
            ...
            // Set Result Acquisition Format at Distance data(polar coordinate)
            this._listCommand.Add(new TOFCommand(0x84, new byte[6] { 0xFE, 0x84, 0x00, 0x02, 0x00, 0x00 }, 6, 6, 1000));
        }
